...
void main() {
  color = vec4(0.0);
  if (kernelSize == 3) {
    color += texture(blurSrc, textureCoord + 0.5 * d) * 0.5;
    color += texture(blurSrc, textureCoord - 0.5 * d) * 0.5;
  } else if (kernelSize == 5) {
    vec2[2] kernel = vec2[2](vec2(0, 0.375), vec2(1.2, 0.3125));
    color += texture(blurSrc, textureCoord) * kernel[0].y;
    color += texture(blurSrc, textureCoord + kernel[1].x * d) * kernel[1].y;
    color += texture(blurSrc, textureCoord - kernel[1].x * d) * kernel[1].y;
  } else if (kernelSize == 7) {
    vec2[2] kernel =
        vec2[2](vec2(0.6, 0.390625), vec2(2.142857142857143, 0.109375));
    color += texture(blurSrc, textureCoord + kernel[0].x * d) * kernel[0].y;
    color += texture(blurSrc, textureCoord - kernel[0].x * d) * kernel[0].y;
    color += texture(blurSrc, textureCoord + kernel[1].x * d) * kernel[1].y;
    color += texture(blurSrc, textureCoord - kernel[1].x * d) * kernel[1].y;
    ...
    color += texture(blurSrc, textureCoord + kernel[1].x * d) * kernel[1].y;
    color += texture(blurSrc, textureCoord - kernel[1].x * d) * kernel[1].y;
    color += texture(blurSrc, textureCoord + kernel[2].x * d) * kernel[2].y;
    color += texture(blurSrc, textureCoord - kernel[2].x * d) * kernel[2].y;
    ...
    color += texture(blurSrc, textureCoord + kernel[2].x * d) * kernel[2].y;
    color += texture(blurSrc, textureCoord - kernel[2].x * d) * kernel[2].y;
    color += texture(blurSrc, textureCoord + kernel[3].x * d) * kernel[3].y;
    color += texture(blurSrc, textureCoord - kernel[3].x * d) * kernel[3].y;
    ...
    color += texture(blurSrc, textureCoord + kernel[3].x * d) * kernel[3].y;
    color += texture(blurSrc, textureCoord - kernel[3].x * d) * kernel[3].y;
    color += texture(blurSrc, textureCoord + kernel[4].x * d) * kernel[4].y;
    color += texture(blurSrc, textureCoord - kernel[4].x * d) * kernel[4].y;
    ...
    color += texture(blurSrc, textureCoord + kernel[4].x * d) * kernel[4].y;
    color += texture(blurSrc, textureCoord - kernel[4].x * d) * kernel[4].y;
    color += texture(blurSrc, textureCoord + kernel[5].x * d) * kernel[5].y;
    color += texture(blurSrc, textureCoord - kernel[5].x * d) * kernel[5].y;
    ...
    color += texture(blurSrc, textureCoord + kernel[5].x * d) * kernel[5].y;
    color += texture(blurSrc, textureCoord - kernel[5].x * d) * kernel[5].y;
    color += texture(blurSrc, textureCoord + kernel[6].x * d) * kernel[6].y;
    color += texture(blurSrc, textureCoord - kernel[6].x * d) * kernel[6].y;
  }
  color *= blurWeight;
  ...
  color +=
      texture(
          blendSrc,
          textureCoord + vec2(-blendSrcTexelSize.x, -blendSrcTexelSize.y)) *
      0.25 * blendWeight;
  color += texture(
               blendSrc,
               textureCoord + vec2(blendSrcTexelSize.x, -blendSrcTexelSize.y)) *
