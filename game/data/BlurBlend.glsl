...
layout(set = 0, binding = 0) uniform sampler2D blurSrc;
layout(set = 0, binding = 1) uniform sampler2D blendSrc;
layout(set = 0, binding = 2, rgba16f) restrict writeonly uniform image2D dst;
...
void main() {
  ...
  vec4 sum = vec4(0.0);
  if (kernelSize == 3) {
    sum += texture(blurSrc, o + 0.5 * d) * 0.5;
    sum += texture(blurSrc, o - 0.5 * d) * 0.5;
  } else if (kernelSize == 5) {
    vec2[2] kernel = vec2[2](vec2(0, 0.375), vec2(1.2, 0.3125));
    sum += texture(blurSrc, o) * kernel[0].y;
    sum += texture(blurSrc, o + kernel[1].x * d) * kernel[1].y;
    sum += texture(blurSrc, o - kernel[1].x * d) * kernel[1].y;
  } else if (kernelSize == 7) {
    vec2[2] kernel =
        vec2[2](vec2(0.6, 0.390625), vec2(2.142857142857143, 0.109375));
    sum += texture(blurSrc, o + kernel[0].x * d) * kernel[0].y;
    sum += texture(blurSrc, o - kernel[0].x * d) * kernel[0].y;
    sum += texture(blurSrc, o + kernel[1].x * d) * kernel[1].y;
    sum += texture(blurSrc, o - kernel[1].x * d) * kernel[1].y;
    ...
    sum += texture(blurSrc, o + kernel[1].x * d) * kernel[1].y;
    sum += texture(blurSrc, o - kernel[1].x * d) * kernel[1].y;
    sum += texture(blurSrc, o + kernel[2].x * d) * kernel[2].y;
    sum += texture(blurSrc, o - kernel[2].x * d) * kernel[2].y;
    ...
    sum += texture(blurSrc, o + kernel[2].x * d) * kernel[2].y;
    sum += texture(blurSrc, o - kernel[2].x * d) * kernel[2].y;
    sum += texture(blurSrc, o + kernel[3].x * d) * kernel[3].y;
    sum += texture(blurSrc, o - kernel[3].x * d) * kernel[3].y;
    ...
    sum += texture(blurSrc, o + kernel[3].x * d) * kernel[3].y;
    sum += texture(blurSrc, o - kernel[3].x * d) * kernel[3].y;
    sum += texture(blurSrc, o + kernel[4].x * d) * kernel[4].y;
    sum += texture(blurSrc, o - kernel[4].x * d) * kernel[4].y;
    ...
    sum += texture(blurSrc, o + kernel[4].x * d) * kernel[4].y;
    sum += texture(blurSrc, o - kernel[4].x * d) * kernel[4].y;
    sum += texture(blurSrc, o + kernel[5].x * d) * kernel[5].y;
    sum += texture(blurSrc, o - kernel[5].x * d) * kernel[5].y;
    ...
    sum += texture(blurSrc, o + kernel[5].x * d) * kernel[5].y;
    sum += texture(blurSrc, o - kernel[5].x * d) * kernel[5].y;
    sum += texture(blurSrc, o + kernel[6].x * d) * kernel[6].y;
    sum += texture(blurSrc, o - kernel[6].x * d) * kernel[6].y;
  }
  sum *= blurWeight;
  vec2 blendSrcTexelSize = 1.0 / textureSize(blendSrc, 0);
  sum += texture(blendSrc, o + vec2(-blendSrcTexelSize.x, -blendSrcTexelSize.y)) * 0.25 * blendWeight;
  sum += texture(blendSrc, o + vec2(blendSrcTexelSize.x, -blendSrcTexelSize.y)) * 0.25 * blendWeight;
  sum += texture(blendSrc, o + vec2(-blendSrcTexelSize.x, blendSrcTexelSize.y)) * 0.25 * blendWeight;
  sum += texture(blendSrc, o + vec2(blendSrcTexelSize.x, blendSrcTexelSize.y)) * 0.25 * blendWeight;
  // sum += texture(blendSrc, o) * blendWeight;
