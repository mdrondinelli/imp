...
export module mobula.gpu:PipelineLayoutCache;
import <mutex>;
...
namespace mobula {
  namespace gpu {
    ...
    public:
       ...
       * previous invocation, it returns the same pipeline layout as the first
       * invocation. Otherwise, this function creates and returns a new pipeline
       * layout.
       *
    ...
    private:
      ...
      struct Equal {
        ...
        bool operator()(PipelineLayout const &lhs, PipelineLayout const &rhs)
            const noexcept {
          return &lhs == &rhs;
        }
