...
export module mobula.gpu:PipelineCache;
import <mutex>;
...
namespace mobula {
  namespace gpu {
    ...
    public:
       ...
       * previous invocation, it returns the same pipeline as the first
       * invocation. Otherwise, this function creates and returns a new
       * pipeline.
       *
    ...
    private:
      ...
      struct GraphicsPipelineHash {
        ...
        std::size_t operator()(GraphicsPipelineParams const
                                   &graphicsPipelineParams) const noexcept {
