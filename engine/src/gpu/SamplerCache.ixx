...
export module mobula.gpu:SamplerCache;
import <mutex>;
...
namespace mobula {
  namespace gpu {
    ...
    public:
       ...
       * previous invocation, it returns the same sampler as the first
       * invocation. Otherwise this function creates and returns a new sampler.
       *
    ...
    private:
      ...
      struct Equal {
        ...
        bool operator()(
            Sampler const &lhs, SamplerParams const &rhs) const noexcept {
          return lhs.getParams() == rhs;
        }

        bool operator()(
            SamplerParams const &lhs, Sampler const &rhs) const noexcept {
