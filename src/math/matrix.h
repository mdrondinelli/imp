...
namespace imp {
  ...
  using matrix1x1i = matrix1x1<float>;
  using matrix1x2i = matrix1x2<int>;
  using matrix1x3i = matrix1x2<int>;
  using matrix1x4i = matrix1x4<int>;
  using matrix2x1i = matrix2x1<int>;
  using matrix2x2i = matrix2x2<int>;
  using matrix2x3i = matrix2x3<int>;
  using matrix2x4i = matrix2x4<int>;
  using matrix3x1i = matrix3x1<int>;
